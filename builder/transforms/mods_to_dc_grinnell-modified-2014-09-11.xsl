...
<xsl:stylesheet version="1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
  ...
  <!--
  xmlns:grinnell="http://digital7.grinnell.edu" exclude-result-prefixes="grinnell" >
...
-->
  ...
  <!-- OK, this next section is critical...it should only select MODS 'note'
	...
	<xsl:template match="/mods:mods/mods:note">
		<dc:description>
<!--  <xsl:value-of select="concat( grinnell:titleCase(@type), ': ', . )"/>  -->
      <xsl:value-of select="concat( @type, ': ', . )"/> 
		</dc:description>
	</xsl:template>
  ...
  <!-- MAM what follows is the origial Islandora 7 transform for mods:typeOfResource,
       but since we put dc:type elements here the mapping should be as presented
       in the new block below this one. 
  ...
  <!-- MAM this is my new mods:typeOfResource mapping to DC.  Pretty simple.  -->
