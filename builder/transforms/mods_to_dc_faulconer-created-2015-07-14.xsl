...
-->
	...
	<xsl:template match="mods:name">
		...
		<xsl:choose>
	    	...
	    	test="mods:role/mods:roleTerm[@type='text']='creator' or mods:role/mods:roleTerm[@type='code']='cre' "> 
				...
				<!-- For Faulconer we need to push the creator name into the dc:description! --> 
  ...
  <!-- OK, this next section is critical...it should only select MODS 'note'
	...
	<!-- For Faulconer objects, don't push Notes into dc:description! 
    ...
    <!-- For Faulconer objects, don't push the abstract or tableOfContents into dc:description!
